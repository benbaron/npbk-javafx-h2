...
public class MainWindow extends BorderPane
{
    ...
    private static final double SIDE_PANE_MIN_WIDTH = 0;
    private static final double CENTER_MIN_WIDTH = 240;
    ...
    public MainWindow(Database database)
    {
        ...
        setCenter(buildWorkspaceSplitPane());
    ...
    {
        navigationPane.setMinWidth(SIDE_PANE_MIN_WIDTH);
        navigationPane.setPrefWidth(NAVIGATION_PREF_WIDTH);
        navigationPane.setMaxWidth(Double.MAX_VALUE);

        inspectorPane.setMinWidth(SIDE_PANE_MIN_WIDTH);
        inspectorPane.setPrefWidth(INSPECTOR_PREF_WIDTH);
        inspectorPane.setMaxWidth(Double.MAX_VALUE);
    }
    ...
    private SplitPane buildWorkspaceSplitPane()
    {
        ...
        splitPane.setDividerPositions(0.20, 0.79);
        BorderPane.setMargin(splitPane, new Insets(8));
        return splitPane;
    }
    ...
    private ScrollPane buildCenterScrollPane()
    {
        ...
        panelHost.setPrefSize(Region.USE_COMPUTED_SIZE, Region.USE_COMPUTED_SIZE);
        ...
        scrollPane.setMinWidth(CENTER_MIN_WIDTH);
